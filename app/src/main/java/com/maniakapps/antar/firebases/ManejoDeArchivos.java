...
public class ManejoDeArchivos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences preferencias = getSharedPreferences("pref", MODE_PRIVATE);
        contenio = preferencias.getString("caloria", null);
